...
(function () {
  ...
  const SEQUENCE = [
    ...
    { id: 'cycles-temporels',      label: 'Cycles Temporels',                  cat: 'Temps' },
    { id: 'temps-prix-protocole',  label: 'Temps & Prix — Protocole',          cat: 'Temps' },
    { id: 'ipda-trainer',          label: 'Algorithme de Livraison du Prix',   cat: 'Temps' },
    { id: 'modeles-de-marche',     label: 'Modèles de Marché',                 cat: 'Temps' },
    { id: 'protocole-trading',     label: 'Protocole Complet',                 cat: 'Temps' },
    { id: 'modeles-execution',     label: 'Playbooks & Modèles',               cat: 'Temps' },
    { id: 'execution-avancee',     label: 'Exécution Avancée',                 cat: 'Temps' },
    { id: 'execution-live-series', label: 'Sessions Live',                     cat: 'Temps' },
    ...
    { id: 'ranges-fractals',       label: 'Ranges & Fractales',                cat: 'Architecture' },
    { id: 'digital-time-theory',   label: 'Théorie du Temps Numérique',        cat: 'Architecture' },
    { id: 'sequences-fractales',   label: 'Séquences & Fractales',             cat: 'Architecture' },
    { id: 'strategie-entree',      label: "Stratégies d'Entrée",               cat: 'Architecture' },
    { id: 'etudes-de-cas',         label: 'Études de Cas',                     cat: 'Architecture' },
  ];
