...
(function() {
  const MODULES = [
    ...
    { id: 'ict-macro-news',     label: '13. AA Macro+News' },
    { id: 'aa-liquidity-inducement', label: '14. AA MS+IDM' },
    { id: 'fiches-ict',            label: '15. Fiches ICT' },
    { id: 'fiches-catalogue',      label: '16. Catalogue PDFs' },
    { id: 'fiches-avancees',       label: '17. Fiches Avancees' },
    { id: 'fiches-visuelles',      label: '18. Fiches Visuelles' },
    { id: 'htf-structure-org',     label: '19. AA HTF Structure' },
    { id: 'dr-ote-mtf',            label: '20. AA DR OTE MTF' },
    { id: 'qt-cycles',             label: '21. AA QT Cycles' },
  ];
